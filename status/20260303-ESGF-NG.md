# 2026-03-03 ESGF-NG Status

ESGF-NG status as of March, 2026.
...
* ESGF2-US is working on production deployment of the ESGF Event Stream and ESGF-West STAC catalog. ESGF2-US has elected to continue using the existing University of Chicago AWS environment for deployment and is working on populating it with the ESGF-West production services. We hope both CEDA and ESGF2-US will be ready for onboarding publishers this month (March).
...
* Discussing plans to use Github actions/workflows for versioning CV from esgvoc. See more [here](https://github.com/ESGF/esgf-roadmap/issues/145#issuecomment-3996503752).
...
The ESGF2-US team has elected to continue using the existing University of Chicago AWS environment for deployment instead of setting up a new AWS environment via Argonne or Oak Ridge. The Globus Operations team will deploy and operate the ESGF-West core architecture in this environment. The March deployment includes:
...
This work will continue in March. Issues are tracked in [this Github project epic](https://github.com/ESGF/esgf-roadmap/issues/95).
...
This work will continue in March. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/121).
...
This work will continue in March. Issues are tracked in [this GitHub project epic](https://github.com/ESGF/esgf-roadmap/issues/97).
